...
<<<<<<< HEAD
        ...
        /* Chrome/Chromium browsers decoration container for password reveal */
                ...
                <form method="POST" class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <!-- ADDED pr-12 HERE to create space on the right for the eye (if you add one later) -->
                            <input type="password" id="adminPassword" name="admin_password" class="pl-10 pr-12 w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent input-focus" placeholder="••••••••" required>
                        </div>
                    </div>
