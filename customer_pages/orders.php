                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-4 sm:px-6 py-3 sm:py-4 border-b flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-gray-500 mt-1">
                            #<?php echo htmlspecialchars($order['id_pekerjaan']); ?>
                            <span class="mx-1 sm:mx-2">•</span>
                            <i data-feather="calendar" class="w-3 h-3 inline"></i>
                            <?php echo date('d M Y', strtotime($order['dibuat_pada'])); ?>
                        </p>
                    </div>
                        ...
                        <div class="space-y-2 sm:space-y-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-800"><?php echo htmlspecialchars($order['nama_pekerja']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-start">
                        ...
                        <div class="space-y-2 sm:space-y-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-800"><?php echo htmlspecialchars($order['lokasi']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-start">
